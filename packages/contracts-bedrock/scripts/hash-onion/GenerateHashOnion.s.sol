...
///         * Make sure to don't have any duplicated remote token on the tokens json, there is
...
contract GenerateHashOnion is Script {
    ...
    IOptimismERC20Factory internal constant FACTORY = IOptimismERC20Factory(Predeploys.OPTIMISM_MINTABLE_ERC20_FACTORY);
