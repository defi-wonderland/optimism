...
contract TestLiquidityController is Script {
    ...
    address payable private constant L2_PROXY_ADMIN_OWNER = payable(0x2Def9f34f2b68B667Df303D23EDe392BD36Fb177);
    ...
    function run() external {
        ...
        (bool success,) = L2_PROXY_ADMIN_OWNER.call{ value: 1 ether }("");
