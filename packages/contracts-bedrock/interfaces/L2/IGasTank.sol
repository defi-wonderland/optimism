...
interface IGasTank {
  ...
  function decodeGasReceiptPayload(bytes calldata payload) external pure returns (
      bytes32 msgHash,
      bytes32 rootMsgHash,
      address relayer,
      uint256 relayCost
