...
//                     abi.encodeCall(OptimismOptimismSuperchainERC20.initialize, (_remoteToken, _name, _symbol,
// _decimals))
//                 )
//             )
//         );
...
//         optimismOptimismSuperchainERC20.initialize(_remoteToken, _name, _symbol, _decimals);
//     }
...
//         OptimismSuperchainERC20 _newSuperchainERC20 = _deploySuperchainERC20Proxy(REMOTE_TOKEN, NAME, SYMBOL,
// _decimals);
...
//         OptimismSuperchainERC20 _newSuperchainERC20 = _deploySuperchainERC20Proxy(_remoteToken, NAME, SYMBOL,
// DECIMALS);
...
//         OptimismSuperchainERC20 _newSuperchainERC20 = _deploySuperchainERC20Proxy(REMOTE_TOKEN, NAME, _symbol,
// DECIMALS);
