...
#         bash ./test/properties/kontrol/utils/record-state-diff.sh to run it  #
################################################################################
...
export STATE_DIFF_DIR=supererc20-state-diff # Relative to the Foundry root directory
...
RECORDING_CONTRACT_DIR=test/properties/kontrol # Relative to the Foundry root directory
RECORDING_CONTRACT_FILE=KontrolBase.sol # Name of the Solidity file
RECORDING_CONTRACT_NAME=KontrolBase # Name of the actual contract
RECORDING_CONTRACT_FUNCTION=setUpNamed # Name of the function with the recordStateDiff modifier
...
GENERATED_CONTRACT_DIR=test/properties/kontrol/deployments # Relative to the Foundry root directory
