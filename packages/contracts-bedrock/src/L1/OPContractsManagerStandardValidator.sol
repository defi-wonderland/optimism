...
contract OPContractsManagerStandardValidator is ISemver {
        ...
        returns (string memory)
    {
        ...
        LibGameArgs.ZKGameArgs memory decoded = LibGameArgs.decodeZK(factory.gameArgs(GameTypes.ZK_DISPUTE_GAME));
        IAnchorStateRegistry asr = IAnchorStateRegistry(decoded.anchorStateRegistry);
        IDelayedWETH weth = IDelayedWETH(payable(decoded.weth));
        uint256 chainId = decoded.l2ChainId;
