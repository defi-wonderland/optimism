...
abstract contract FeeVault is ProxyAdminOwnedBase, Initializable {
    /// @notice Error thrown when the fee splitter is set as the recipient and the withdrawal network is not L2.
    error FeeVault_MustHaveL2WithdrawalNetwork();
    ...
    function setRecipient(address _newRecipient) external {
        ...
        if (_newRecipient == Predeploys.FEE_SPLITTER && withdrawalNetwork() != Types.WithdrawalNetwork.L2) {
            revert FeeVault_MustHaveL2WithdrawalNetwork();
        }
    ...
    function setWithdrawalNetwork(Types.WithdrawalNetwork _newWithdrawalNetwork) external {
        ...
        if (recipient() == Predeploys.FEE_SPLITTER && _newWithdrawalNetwork == Types.WithdrawalNetwork.L1) {
            revert FeeVault_MustHaveL2WithdrawalNetwork();
        }
