...
func makeDCI(intent *state.Intent, thisIntent *state.ChainIntent, chainID common.Hash, st *state.State) (opcm.DeployOPChainInput, error) {
	...
	return opcm.DeployOPChainInput{
		...
		FeeVaultAdmin:                            thisIntent.Roles.SystemConfigFeeAdmin,
		...
		BaseFeeVaultMinWithdrawalAmount:          thisIntent.BaseFeeVaultMinimumWithdrawalAmount.ToInt(),
		BaseFeeVaultWithdrawalNetwork:            thisIntent.BaseFeeVaultWithdrawalNetwork.ToUint8(),
		SequencerFeeVaultRecipient:               thisIntent.SequencerFeeVaultRecipient,
		SequencerFeeVaultMinWithdrawalAmount:     thisIntent.SequencerFeeVaultMinimumWithdrawalAmount.ToInt(),
		SequencerFeeVaultWithdrawalNetwork:       thisIntent.SequencerFeeVaultWithdrawalNetwork.ToUint8(),
		L1FeeVaultRecipient:                      thisIntent.L1FeeVaultRecipient,
		L1FeeVaultMinWithdrawalAmount:            thisIntent.L1FeeVaultMinimumWithdrawalAmount.ToInt(),
		L1FeeVaultWithdrawalNetwork:              thisIntent.L1FeeVaultWithdrawalNetwork.ToUint8(),
		OperatorFeeVaultRecipient:                thisIntent.OperatorFeeVaultRecipient,
		OperatorFeeVaultMinWithdrawalAmount:      thisIntent.OperatorFeeVaultMinimumWithdrawalAmount.ToInt(),
		OperatorFeeVaultWithdrawalNetwork:        thisIntent.OperatorFeeVaultWithdrawalNetwork.ToUint8(),
	}, nil
}
