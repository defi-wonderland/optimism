...
const (
	...
	DependencyManager             = "0x4200000000000000000000000000000000000029"
...
var (
	...
	DependencyManagerAddr             = common.HexToAddress(DependencyManager)
...
func init() {
	...
	Predeploys["DependencyManager"] = &Predeploy{Address: DependencyManagerAddr}
