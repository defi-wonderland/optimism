...
func DeployL2ToL1(l1Host *script.Host, superCfg *SuperchainConfig, superDeployment *SuperchainDeployment, cfg *L2Config) (*L2Deployment, error) {
	...
	output, err := opcm.DeployOPChain(l1Host, opcm.DeployOPChainInput{
		...
		FeeVaultAdmin:                        cfg.SystemConfigFeeAdmin,
		BaseFeeVaultRecipient:                cfg.BaseFeeVaultRecipient,
		BaseFeeVaultMinWithdrawalAmount:      cfg.BaseFeeVaultMinimumWithdrawalAmount.ToInt(),
		BaseFeeVaultWithdrawalNetwork:        cfg.BaseFeeVaultWithdrawalNetwork.ToUint8(),
		SequencerFeeVaultRecipient:           cfg.SequencerFeeVaultRecipient,
		SequencerFeeVaultMinWithdrawalAmount: cfg.SequencerFeeVaultMinimumWithdrawalAmount.ToInt(),
		SequencerFeeVaultWithdrawalNetwork:   cfg.SequencerFeeVaultWithdrawalNetwork.ToUint8(),
		L1FeeVaultRecipient:                  cfg.L1FeeVaultRecipient,
		L1FeeVaultMinWithdrawalAmount:        cfg.L1FeeVaultMinimumWithdrawalAmount.ToInt(),
		L1FeeVaultWithdrawalNetwork:          cfg.L1FeeVaultWithdrawalNetwork.ToUint8(),
		OperatorFeeVaultRecipient:            cfg.OperatorFeeVaultRecipient,
		OperatorFeeVaultMinWithdrawalAmount:  cfg.OperatorFeeVaultMinimumWithdrawalAmount.ToInt(),
		OperatorFeeVaultWithdrawalNetwork:    cfg.OperatorFeeVaultWithdrawalNetwork.ToUint8(),
	})
	if err != nil {
